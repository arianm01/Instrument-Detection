...
def train(X_train, y_train, X_val, y_val, experts):
    ...
    gating_network.fit(X_train, y_train, validation_data=(X_val, y_val), epochs=50, batch_size=4,
...
def generate_performance_labels(experts, X_train, y_train, chunk_size=44, batch_size=64):
