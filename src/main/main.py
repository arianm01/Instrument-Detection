...
def main():
    ...
    # models = [load_model('../../output/5 class/CNN/1 second/model_best_CNN_8.h5'),
    #           load_model('../../output/5 class/CNN/1 second/model_best_CNN_9.h5'),
    #           load_model('../../output/5 class/CNN/1 second/model_best_CNN_10.h5'),
